...
- **Unified AmberFAB**: Created and implemented a reusable `AmberFAB` component across all primary screens (Inventory, Warehouse, Staff, POS, etc.), featuring an amber gradient, custom shadows, `Hero` animation support, and a fixed minimum width for a consistent "Ribaplus" feel.
