...
class SalesDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isProfitMode = mode == 'profit';
      ...
      body: rows.isEmpty
          ...
          : Column(
              children: [
                ...
                // ── Table header ─────────────────────────────────────────
                _buildTableHeader(context, showProfit: isProfitMode && hasProfit),
  ...
  Widget _buildTableHeader(BuildContext context, {required bool showProfit}) {
    final subtext = Theme.of(context)
        .colorScheme
        .onSurface
        ...
        children: [
          ...
          if (showProfit)
            SizedBox(
              width: context.getRSize(80),
              child:
                  Text('PROFIT', style: style, textAlign: TextAlign.right),
            ),
        ],
      ),
    );
  ...
  Widget _buildRow(
    ...
    final profitColor = row.profit == null
        ...
        : (row.profit! >= 0 ? const Color(0xFF22C55E) : theme.colorScheme.error);
